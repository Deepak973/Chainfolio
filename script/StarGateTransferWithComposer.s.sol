...
contract StargateTransferScript is Script {
    ...
    function run() external {
        ...
        bytes memory _composeMsg = abi.encode(_tokenReceiver, _oftOnDestination);
       
        (uint256 valueToSend, SendParam memory sendParam, MessagingFee memory messagingFee) =
        integration.prepareTakeTaxi(stargatePoolUSDC, destinationEndpointId, amount, 0xD62372709e1b3Ac4B5b26091EF84e33274d6201E, _composeMsg);

        IStargate(stargatePoolUSDC).sendToken{ value: valueToSend }(sendParam, messagingFee, 0xD62372709e1b3Ac4B5b26091EF84e33274d6201E);
